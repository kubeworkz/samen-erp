# Bootstrap helper (E8): reserve the three Reports/BI abbrevs through the
# SANCTIONED allocator — never by hand (ADR-023). Run like:
#
#   cd samen_core
#   elixir -pa _build/dev/lib/samen_core/ebin -pa _build/dev/lib/jason/ebin \
#     priv/reserve_e8_abbrevs.exs
#
# The direct Allocator.reserve!/4 route (idempotent: same host+abbrev+owner is
...
host = "samen_core"
owner_prefix = "SamenCore.Support.FinanceFixture"

reservations = [
  {"sbd", owner_prefix <> ".Budget"},
  {"sbe", owner_prefix <> ".BudgetLine"},
