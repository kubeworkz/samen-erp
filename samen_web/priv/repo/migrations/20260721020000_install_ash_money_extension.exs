defmodule Samen.WebTest.Repo.Migrations.InstallAshMoneyExtension do
  @moduledoc """
  ...
  defines — the storage shape the H1 Money migration
  (`20260721030000_h1_money_migration`) needs before it can add the
  `swo_value`/`wbr_unit_amount` composite columns.

  Content generated via `AshMoney.AshPostgresExtension.install/1` for versions 0-5
  (mirrors `Demo.Repo.Migrations.InstallAshMoneyExtension` — see its moduledoc for
  the full rationale).
  """
