defmodule Samenerp.Seeds do
  @moduledoc """
  Samenerp dev-data seeds (WS-D D4 / AC-G4-4), vault-aware BY CONSTRUCTION.
  ...
  Run via `mix samenerp.seed` (which starts the app first).
  """
  ...
  @org_id "0f000000-0000-4000-8000-0000000000aa"
