defmodule SamenerpWeb.Api.Endpoint do
  @moduledoc """
  ...
  Pipeline order:
    ...
    1. `SamenerpWeb.Api.KeyAuthPlug` — resolve the `Authorization: Bearer <key>`
    ...
    3. `SamenerpWeb.Api.Router` — the generated AshJsonApi router over the SAME
  ...
  plug(SamenerpWeb.Api.KeyAuthPlug)
  plug(Samen.Web.Api.PageLimitClamp)
  plug(SamenerpWeb.Api.Router)
end
