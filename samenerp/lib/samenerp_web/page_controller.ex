defmodule SamenerpWeb.PageController do
  ...
  def index(conn, _params) do
    html(conn, """
    <!DOCTYPE html>
    <html><head><title>Samenerp — a Samen vertical</title>
    ...
    <body>
      ...
      <ul>
        <li><strong>Finance:</strong> <a href="/erp/coa">Chart of Accounts</a> · <a href="/erp/entries">Journal</a></li>
        <li><strong>Procurement:</strong> <a href="/erp/ap_invoices">AP Invoices</a> · <a href="/erp/purchase_orders">Purchase Orders</a></li>
        <li><strong>Inventory:</strong> <a href="/erp/stock">Stock</a></li>
        <li><strong>Manufacturing:</strong> <a href="/erp/work_orders">Work Orders</a></li>
      </ul>
      <h2>Inherited (samen_web mounts)</h2>
      <ul>
      ...
      <div class="note">
        The six ERP surfaces above are mounted by one <code>samen_erp_routes</code> line and
        rendered by one bounded, read-only framework LiveView. HR is implemented in the
        shared core as a reveal-gated domain, but is not yet mounted as a standalone Samenerp
        route. The host still authors 0 Samenerp LiveView modules.
      </div>
    </body></html>
    """)
  end
