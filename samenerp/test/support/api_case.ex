defmodule Samenerp.ApiCase do
  ...
  `SamenerpWeb.Api.Endpoint` pipeline (key-auth → page-limit clamp → AshJsonApi
  ...
  def mk_api_key(org_id, opts \\ []) do
    ...
    digest = SamenerpWeb.Api.KeyAuthPlug.digest(raw)
  ...
  `key`. Drives the `SamenerpWeb.Api.Endpoint` pipeline.
  """
  def api_get(path, key \\ nil) do
    ...
    SamenerpWeb.Api.Endpoint.call(conn, SamenerpWeb.Api.Endpoint.init([]))
  end
