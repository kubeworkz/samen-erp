defmodule Samen.Extension do
  ...
  (S0.4 reuses the S0.2 transformer so introspection yields prefixed sources.)
  """
...
defmodule Samen.Resource do
  @moduledoc """
  Prototype base macro for Samen resources. Reused from the S0.2 spike; provides
  the abbrev-prefixed storage that S0.4's catalog diff records.
  """
